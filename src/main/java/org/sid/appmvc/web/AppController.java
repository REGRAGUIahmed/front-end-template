...
public class AppController {
    ...
    public String delcustomer(@PathVariable Long id, Model model){
        keycloakRestTemplate.getForObject("http://localhost:8095/bills/delCustomer/"+id, PagedModel.class);
    ...
    public String products(@PathVariable Long id, Model model){
        keycloakRestTemplate.getForObject("http://localhost:8095/bills/delProduct/"+id, PagedModel.class);
    ...
    public String factures(@PathVariable Long id){
        keycloakRestTemplate.getForObject("http://localhost:8095/bills/del/"+id, PagedModel.class);
    ...
    public String factures(Model model){
        ResponseEntity<List<Bill>> response= keycloakRestTemplate.exchange("http://localhost:8095/Allbills",
